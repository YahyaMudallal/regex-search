 ...
 *
 * <p>Les démonstrations sont indépendantes : l'arbre syntaxique n'est pas encore
 * converti en automate, et les fichiers ne sont pas encore parcourus pour rechercher
 * un motif. Le programme doit être lancé depuis la racine du projet pour accéder
 * au dossier {@code Samples}.</p>
 */
public class Main {
